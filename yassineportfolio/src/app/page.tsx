          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group h-full">
                ...
                h-full
                ">
                  <div className="aspect-square p-6 bg-light-surface dark:bg-dark-surface items-center justify-center h-full flex flex-col">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative">
            ...
            h-full
            ">
              <div className="relative p-12 bg-light-surfaceContainerLow dark:bg-dark-surfaceContainerLow h-full">
