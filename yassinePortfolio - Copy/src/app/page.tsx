...
import { ArrowRight, Sparkles, Code, Rocket, Mail, Github, Linkedin, Twitter } from "lucide-react";
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-light-primaryContainer dark:bg-dark-primaryContainer text-light-onPrimaryContainer dark:text-dark-onPrimaryContainer">
                  ...
                  <span className="text-label-medium">Frontend Developer & UI Specialist</span>
                </div>
                
                <h1 className="text-display-small md:text-display-medium lg:text-display-large text-light-onBackground dark:text-dark-onBackground font-bold">
                  Crafting Digital
                  <span className="block text-light-primary dark:text-dark-primary">Experiences</span>
                  That Inspire
                </h1>
                ...
                <p className="text-body-large text-light-onSurfaceVariant dark:text-dark-onSurfaceVariant max-w-2xl">
                  ...
                  With 5+ years of experience in modern web technologies, 
              ...
              >
                <div className="relative overflow-hidden rounded-3xl mb-6">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                    <span className="text-label-large text-white">View Case Study →</span>
                  </div>
                </div>
